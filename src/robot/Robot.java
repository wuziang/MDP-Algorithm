...
public class Robot {
    ...
    private void updateReturnedStart() {
        if (this.getRobotPosRow() == RobotConstants.START_ROW && this.getRobotPosCol() == RobotConstants.START_COL){
            this.returnedStart = this.getReachedGoal();
        }
    }

    public boolean getReturnedStart() {
